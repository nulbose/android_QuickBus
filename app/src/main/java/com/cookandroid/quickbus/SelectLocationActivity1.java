...
public class SelectLocationActivity1 extends AppCompatActivity {
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedDeparture != null && selectedDestination != null) {
                    Intent intent = new Intent(SelectLocationActivity1.this, TimetableActivity.class);
                    ...
                    Toast.makeText(SelectLocationActivity1.this, "출발지와 도착지를 모두 선택하세요.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
